...
# plotFilePath = r'c:\Users\marliesvanderl\phd\analysis\fig\20210908_SEDMEX\20211215_qualitycontrol_solo//'
rho = 1028
g = 9.8
...
for instr in instruments[:3]:
    ...
    #beacuse we rely on index number for the timing
    ...
    ds2.attrs = ds.attrs 
    ds2.attrs['summary'] = 'SEDMEX field campaign, pressure corrected for drift air pressure. There are inconsistencies between de mean pressure measured with ossis and solos.' 
